...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ACodingTestActor_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ACodingTestActor_Add, "Add" }, // 1465642102
	};
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FIntPropertyParams Z_Construct_UClass_ACodingTestActor_Statics::NewProp_number1 = { "number1", nullptr, (EPropertyFlags)0x0020080000000005, UE4CodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(ACodingTestActor, number1), METADATA_PARAMS(Z_Construct_UClass_ACodingTestActor_Statics::NewProp_number1_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ACodingTestActor_Statics::NewProp_number1_MetaData)) };
#if WITH_METADATA
	...
	IMPLEMENT_CLASS(ACodingTestActor, 3821457786);
